    ...
    <div class="d-flex-center w-v h-v">
        <div class="login-card">
            <div class="login-card-content">
                ...
                <form method="post" @submit="onSubmit" id="change-password-form">
                    <div class="input-title">Old Password:<span class="input-title-require">*</span></div>
                    <div>
                        <InputBox 
                    ...
                    <div class="d-flex-h-center">
                        <BtnBox :loading="authStore.btnLoading" class="btn-primary btn-mid" btnType="submit" block>Submit</BtnBox>
                    </div>
                </form>
...
<script setup>
     ...
     */
     ...
     const onSubmit = handleSubmit(() => {
        let fs = new FormData(document.getElementById('change-password-form'));      
        authStore.changePassword(fs, setFieldError);
    });
</script>
